...
projection for my raster is unknown.. let's force it :
```{r}
# Update your raster to use standard Canada Albers
dbExecute(con, "
  SELECT UpdateRasterSRID('crop_inventory', 'aci_2024_qc', 'rast', 3978);
")
```
