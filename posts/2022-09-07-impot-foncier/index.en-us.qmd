...
pumf_qc_bin <- pumf_qc %>% 
  ...
  mutate(taux_taxation_sur_patrimoine_bin = cut(taux_taxation_sur_patrimoine, c(-Inf,0, 0.0025, 0.0050, 0.0075, 0.01, 0.0125, 0.0150, 0.0175, 0.02, 0.03,0.05, Inf), right = TRUE)) %>%
  mutate(
    taux_taxation_sur_patrimoine_bin = factor(case_when(
      ...
      taux_taxation_sur_patrimoine_bin == "(0.03,0.05]" ~ "3.00 à 5.00%",
    ...
    levels = c("0", "0.00 à 0.25%","0.25 à 0.50%", "0.50 à 0.75%",
               ...
               "2.00 à 3.00%","3.00 à 5.00%", "5.00% et plus"
    )
