...
file_name) et j'ai ajouté ça à mon serveur PostGIS. Ça ressemble un peu
à ça:
...
panne-bâtiments compte un débile `284 841 906` lignes et a pris 2
minutes à calculer sur mon ryzen 5600g.
...
Seize-Iles.\
Ce pauvre type au 202 Côté Estate du Lac à côté du Lac des Seize perdu
le courant 68 jours au cours des 3 dernières années. J'avoue que j'ai
envie de le déclarer champion car il a accumulé un peu de pannes à tous
les mois.
...
# appendice: Obtenir les données info-panne

Pour ceux que ça intéresse (absolument personne) , voici comment j'ai
fait pour organiser toutes les backups.
